class Car {
  ...
  render() {
    ...
    <div class="card px-2 py-5 align-items-center">
            <img src="${this.image}" class="card-img-top img-fluid">
            <div class="card-body col-12">
                <h5 class="card-title fs-6">${this.manufacture}</h5>
                <h5 class="card-title fs-6">${this.model}</h5>
                ...
                <a href="#" class="btn btn-search text-white" style="width:100%">Go somewhere</a>
            </div>
        </div>
`;
  }
